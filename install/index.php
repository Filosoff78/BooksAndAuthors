...
class rsb_books extends CModule
{
    protected $tables = [
        \RSB\Books\ORM\AuthorsTable::class,
        \RSB\Books\ORM\BooksTable::class,
    ];
    ...
    public function __construct()
    {
        ...
        $this->MODULE_ID = 'rsb.books';
        $this->MODULE_NAME = Loc::getMessage('RSB_BOOKS_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('RSB_BOOKS_MODULE_DESCRIPTION');
    ...
    function InstallPublicMenu()
    {
        ...
        $arFields = [
            "CODE" => "menu_books",
            "TITLE" => Loc::getMessage('RSB_BOOKS_MENU_BOOKS'),
    ...
    {
        $folders = [
            Application::getDocumentRoot() . '/local/components/rsb/books.edit',
            Application::getDocumentRoot() . '/local/components/rsb/books.list',
            Application::getDocumentRoot() . '/local/components/rsb/books.field.authors',
            Application::getDocumentRoot() . '/rsb/books/',
        ];
    ...
    function InstallEvents()
    {
        ...
        $eventManager->registerEventHandler(
            ...
            'OnUserTypeBuildList',
            $this->MODULE_ID,
            '\RSB\Books\UserField\Types\AuthorsTypes',
