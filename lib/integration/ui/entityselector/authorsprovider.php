<?php
namespace RSB\Books\Integration\UI\EntitySelector;

use Bitrix\UI\EntitySelector;
use RSB\Books\ORM\AuthorsTable;

class AuthorsProvider extends EntitySelector\BaseProvider {
    private const ELEMENT_LIMIT = 100;

    protected const ENTITY_ID = 'authors';
